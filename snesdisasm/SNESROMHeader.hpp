...
public:
    explicit operator unsigned int() const { return idx; };
    constexpr static unsigned int count = 6;
    static NativeIV COP(){ return NativeIV(0); }
    static NativeIV BRK(){ return NativeIV(1); }
    static NativeIV ABORT(){ return NativeIV(2); }
    static NativeIV NMT(){ return NativeIV(3); }
    static NativeIV UNUSED(){ return NativeIV(4); }
    static NativeIV IRQ(){ return NativeIV(5); }
};
...
public:
    explicit operator unsigned int() const { return idx; };
    constexpr static unsigned int count = 6;
    static EmulationIV COP(){ return EmulationIV(0); }
    static EmulationIV UNUSED(){ return EmulationIV(1); }
    static EmulationIV ABORT(){ return EmulationIV(2); }
    static EmulationIV NMI(){ return EmulationIV(3); }
    static EmulationIV RESET(){ return EmulationIV(4); }
    static EmulationIV IRQ(){ return EmulationIV(5); }
    static EmulationIV BRK(){ return EmulationIV(5); } //compares positive to IRQ
};
